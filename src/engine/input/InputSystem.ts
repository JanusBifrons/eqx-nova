...
export type InputEventUnion = MouseInputEvent | KeyboardInputEvent | TouchInputEvent;

export type InputEventHandler<T extends InputEvent = InputEventUnion> = (event: T) => void;
...
export class InputSystem implements IInputSystem {
    ...
    private setupEventListeners(): void {
        ...
        // Touch events
        this.element.addEventListener('touchstart', this.boundTouchStartHandler, { passive: false });
        this.element.addEventListener('touchmove', this.boundTouchMoveHandler, { passive: false });
        this.element.addEventListener('touchend', this.boundTouchEndHandler, { passive: false });
